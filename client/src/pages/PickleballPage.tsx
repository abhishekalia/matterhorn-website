  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <section className="py-24 relative overflow-hidden" data-testid="section-submission-options">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-emerald-950/20 to-slate-950" />
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/6 w-96 h-96 rounded-full blur-[150px] animate-pulse bg-emerald-500/10" />
          <div className="absolute bottom-1/4 right-1/6 w-80 h-80 rounded-full blur-[120px] animate-pulse bg-teal-500/10" style={{ animationDelay: "1s" }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full blur-[150px] animate-pulse bg-cyan-500/8" style={{ animationDelay: "2s" }} />
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto mb-16">
            ...
            <div className="group relative" data-testid="card-email-option">
              ...
              <Card className="relative p-8 bg-[#0D1B2A] border-emerald-500/30 backdrop-blur-xl rounded-2xl overflow-hidden h-full">
                {/* Animated Top Border */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-emerald-500 via-teal-400 to-emerald-500" />
                
                {/* Corner Glow */}
                <div className="absolute -top-20 -right-20 w-48 h-48 bg-emerald-500/20 rounded-full blur-3xl group-hover:bg-emerald-500/30 transition-all duration-500" />
                
                {/* Icon with Neon Effect */}
                <div className="relative mb-6">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300" style={{ boxShadow: '0 0 30px rgba(16, 185, 129, 0.4)' }}>
                    <Mail className="w-7 h-7 text-white" />
                  </div>
                </div>
                
                <h3 className="text-xl font-bold text-white mb-3">Email Existing Application</h3>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center gap-3 text-sm text-white p-2.5 rounded-lg bg-white/[0.03] hover:bg-emerald-500/10 transition-colors group/item">
            ...
            <div className="group relative" data-testid="card-digital-option">
              ...
              <Card className="relative p-8 bg-[#0D1B2A] border-cyan-500/30 backdrop-blur-xl rounded-2xl overflow-hidden h-full">
                {/* Animated Top Border */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-500 via-cyan-400 to-teal-500" />
                
                {/* Corner Glow */}
                <div className="absolute -top-20 -right-20 w-48 h-48 bg-cyan-500/20 rounded-full blur-3xl group-hover:bg-cyan-500/30 transition-all duration-500" />
                
                {/* Icon with Neon Effect */}
                <div className="relative mb-6">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300" style={{ boxShadow: '0 0 30px rgba(34, 211, 238, 0.4)' }}>
                ...
                {/* Features List with Hover Effects */}
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center gap-3 text-sm text-white p-2.5 rounded-lg bg-white/[0.03] hover:bg-cyan-500/10 transition-colors group/item">
          ...
          <div className="max-w-5xl mx-auto mb-16">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-slate-400">From submission to coverage in 4 simple steps</p>
            </div>
            
            <div className="relative">
              {/* Connecting Line */}
              <div className="absolute top-10 left-0 right-0 h-0.5 bg-gradient-to-r from-emerald-500 via-teal-400 to-cyan-500 rounded-full hidden md:block" style={{ boxShadow: '0 0 15px rgba(16, 185, 129, 0.3)' }} />
              
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {/* Step 1 */}
                <div className="relative group">
                  <div className="flex flex-col items-center text-center">
                    <div className="w-20 h-20 rounded-xl bg-[#0D1B2A] border-2 border-emerald-500/50 flex items-center justify-center mb-4 group-hover:border-emerald-400 group-hover:scale-110 transition-all duration-300 relative z-10" style={{ boxShadow: '0 0 20px rgba(16, 185, 129, 0.2)' }}>
                      <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/20 to-transparent rounded-xl" />
                      <span className="text-2xl font-bold text-emerald-400">1</span>
                    </div>
                    <h4 className="text-base font-bold text-white mb-1">Submit</h4>
                    <p className="text-slate-400 text-xs leading-relaxed">Email docs or complete our digital form</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  <div className="flex flex-col items-center text-center">
                    <div className="w-20 h-20 rounded-xl bg-[#0D1B2A] border-2 border-teal-500/50 flex items-center justify-center mb-4 group-hover:border-teal-400 group-hover:scale-110 transition-all duration-300 relative z-10" style={{ boxShadow: '0 0 20px rgba(20, 184, 166, 0.2)' }}>
                      <div className="absolute inset-0 bg-gradient-to-br from-teal-500/20 to-transparent rounded-xl" />
                      <span className="text-2xl font-bold text-teal-400">2</span>
                    </div>
                    <h4 className="text-base font-bold text-white mb-1">UW Review</h4>
                    <p className="text-slate-400 text-xs leading-relaxed">Our team evaluates your risk</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  <div className="flex flex-col items-center text-center">
                    <div className="w-20 h-20 rounded-xl bg-[#0D1B2A] border-2 border-cyan-500/50 flex items-center justify-center mb-4 group-hover:border-cyan-400 group-hover:scale-110 transition-all duration-300 relative z-10" style={{ boxShadow: '0 0 20px rgba(34, 211, 238, 0.2)' }}>
                      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-transparent rounded-xl" />
                      <span className="text-2xl font-bold text-cyan-400">3</span>
                    </div>
                    <h4 className="text-base font-bold text-white mb-1">Quote</h4>
                    <p className="text-slate-400 text-xs leading-relaxed">Receive quotes from curated markets</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="text-base font-bold text-white mb-1">Bind</h4>
                    <p className="text-slate-400 text-xs leading-relaxed">Select coverage and get protected</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="bg-[#0D1B2A]/80 border-white/10 backdrop-blur-xl p-6 rounded-xl">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                  <h4 className="text-base font-bold text-white mb-1">Questions? We're here to help.</h4>
                  <p className="text-sm text-slate-400">Our pickleball specialists are ready to assist with your submission.</p>
                </div>
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  <Button
                    variant="outline"
                    asChild
                    className="border-emerald-500/40 text-white bg-white/5 hover:bg-emerald-500/10 hover:border-emerald-500/60"
                  ...
                  <Button
                    variant="outline"
                    asChild
                    className="border-cyan-500/40 text-white bg-white/5 hover:bg-cyan-500/10 hover:border-cyan-500/60"
