    ...
    <div className="min-h-screen bg-[#0A1628] text-white">
      ...
      <section className="py-20 bg-[#0D1B2A] relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full blur-[150px] opacity-30" style={{ backgroundColor: NEON_COLORS.amber }} />
          <div className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full blur-[120px] opacity-20" style={{ backgroundColor: NEON_COLORS.cyan }} />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <Card className="p-8 bg-[#1B2A41]/60 border-white/10 backdrop-blur-sm max-w-xl mx-auto text-center hover-elevate overflow-visible transition-all duration-300">
            <div 
              ...
              style={{ backgroundColor: `${NEON_COLORS.amber}20`, boxShadow: `0 0 30px ${NEON_COLORS.amber}30` }}
            >
              <Truck className="w-8 h-8" style={{ color: NEON_COLORS.amber }} />
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Motor Carrier + IC Application</h3>
