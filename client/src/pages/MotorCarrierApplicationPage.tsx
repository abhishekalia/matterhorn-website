              ...
              <form onSubmit={handleDigitalSubmit} className="space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-4 text-white flex items-center gap-2">
                    <Users className="w-5 h-5" style={{ color: NEON_COLORS.amber }} />
                    Contact Information
                  </h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-4 text-white flex items-center gap-2">
                    <Truck className="w-5 h-5" style={{ color: NEON_COLORS.cyan }} />
                    Fleet Information
                  </h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="dot-number" className="text-white/80">DOT Number</Label>
                      <Input 
                        id="dot-number" 
                        placeholder="DOT #"
                        className="bg-white/5 border-white/20 text-white placeholder:text-white/40"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="fleet-size" className="text-white/80">Number of Independent Contractors *</Label>
                      <Input 
                        id="fleet-size" 
                        type="number" 
                        required 
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="equipment-count" className="text-white/80">Total Equipment Count</Label>
                      <Input 
                        id="equipment-count" 
                        type="number" 
                        placeholder="Number of units"
                        className="bg-white/5 border-white/20 text-white placeholder:text-white/40"
                        data-testid="input-equipment-count"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-4 text-white flex items-center gap-2">
                    <Shield className="w-5 h-5" style={{ color: NEON_COLORS.safetyGreen }} />
                    Coverage Requested
                  </h3>
