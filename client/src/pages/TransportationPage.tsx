    ...
    <div className="min-h-screen bg-[#0A1628] text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full blur-[100px] animate-pulse" style={{ backgroundColor: `${NEON_COLORS.cyan}12`, animationDuration: '4s', animationDelay: '1s' }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-[150px] animate-pulse" style={{ backgroundColor: `${NEON_COLORS.safetyGreen}08`, animationDuration: '5s', animationDelay: '2s' }} />
          ...
          <div className="absolute top-40 right-[15%] w-1.5 h-1.5 rounded-full animate-bounce" style={{ backgroundColor: `${NEON_COLORS.cyan}50`, animationDuration: '4s', animationDelay: '1s' }} />
          <div className="absolute bottom-32 left-[20%] w-1 h-1 rounded-full animate-bounce" style={{ backgroundColor: `${NEON_COLORS.safetyGreen}40`, animationDuration: '3.5s', animationDelay: '0.5s' }} />
          ...
          <div className="absolute bottom-1/4 right-[10%] w-1.5 h-1.5 rounded-full animate-bounce" style={{ backgroundColor: `${NEON_COLORS.cyan}40`, animationDuration: '4.5s', animationDelay: '1.5s' }} />
          ...
          <div className="absolute bottom-0 left-0 right-0 h-px" style={{ background: `linear-gradient(to right, transparent, ${NEON_COLORS.cyan}30, transparent)` }} />
          ...
          <div className="absolute top-0 bottom-0 right-[10%] w-px" style={{ background: `linear-gradient(to bottom, transparent, ${NEON_COLORS.safetyGreen}10, transparent)` }} />
        </div>
